...
; no nosso validate não estamos sendo forward compatible (pode ser interessante quando quero analizar mudanças)
...
(def EstritamentePositivo (s/pred estritamente-positivo? ''estritamento-positivo))
