...
(pprint (Paciente. nil "Guilherme" "18/09/1981"))
(pprint (map->Paciente {:nome "Guilherme", :nascimento "18/9/1981" :rg "222222"}))

(pprint (assoc (Paciente. nil "Guilherme" "18/09/1981") :id 38))
(pprint (class (assoc (Paciente. nil "Guilherme" "18/09/1981") :id 38)))



(println (= (->Paciente 15 "Guilherme" "18/09/1981") (->Paciente 15 "Guilherme" "18/09/1981")))
(println (= (->Paciente 153 "Guilherme" "18/09/1981") (->Paciente 15 "Guilherme" "18/09/1981")))
