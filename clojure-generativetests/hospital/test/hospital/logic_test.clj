...
(deftest cabe-na-fila?-test
  ...
  ; o doseq com um súmbolo e uma sequência gerada funciona
  ; mas talvez não seja o que que queremos em example-based manual, vamos
...
; incluindo muuuuitos casos repetidos
...
; carregada no seu namespace e continuar rodando ela, nesse caso lembrar de restartar
...
; se eu coloquei um bug lá, provavelmente eu coloquei um bug aqui, e ai vaidar true
...
; coloquei sufixo, mas você verá prefixo também no mundo
...
(defspec transfere-tem-que-manter-a-quantidade-de-pessoas 5
         (prop/for-all
           [espera fila-nao-cheia-gen
            ...
            vai-para (gen/vector (gen/elements [:raio-x :ultrasom]) 100)
            ]
